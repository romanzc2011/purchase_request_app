    ...
    >
      <Table>
        <TableHead sx={{background: "linear-gradient(to bottom, #2c2c2c, #800000)"}}>
          <TableRow>
            <TableCell sx={{ color: "white", fontWeight: "bold" }}>BOC</TableCell>
            <TableCell sx={{ color: "white", fontWeight: "bold" }}>Fund</TableCell>
            <TableCell sx={{ color: "white", fontWeight: "bold" }}>Location</TableCell>
            <TableCell sx={{ color: "white", fontWeight: "bold" }}>Description</TableCell>
            <TableCell sx={{ color: "white", fontWeight: "bold" }}>Quantity</TableCell>
            <TableCell sx={{ color: "white", fontWeight: "bold" }}>Price</TableCell>
            <TableCell sx={{ color: "white", fontWeight: "bold" }}>Estimated Cost</TableCell>
        ...
        <TableBody>
          {purchases.map((purchase) => (
            <TableRow key={purchase.BOC}>
              ...
              <TableCell sx={{ color: "white" }}>{purchase.description}</TableCell>
              <TableCell sx={{ color: "white" }}>{purchase.quantity}</TableCell>
              <TableCell sx={{ color: "white" }}>{purchase.price}</TableCell>
              <TableCell sx={{ color: "white" }}>{purchase.estimatedCost}</TableCell>
              <TableCell sx={{ color: "white" }}>{purchase.justification}</TableCell>
              <TableCell>
                <Button
                  variant="contained"
                  color="error"
