...
function App({ isLoggedIn, CUE_GROUP, IT_GROUP }: AppProps) {

    // Bring custom hook for purchase form
    const { createNewID } = usePurchaseForm();

    // Websocket URL
    const WEBSOCKET_URL = computeWSURL("/communicate");
    ...
    const handleLoginSuccess = (_ACCESS_GROUP: boolean, _CUE_GROUP: boolean, _IT_GROUP: boolean) => {
