...
// import { socketEmit, socketioInstance } from "./realtime/socketIOSignals";
...
//     useEffect(() => {
//         if (status === 'done' && socketioInstance.connected) {
//             socketEmit('reset_data', {});
...
//             }
//         }
//     }, [status, socketioInstance.connected, dispatch])
...
//     // Listen for socketioInstance messages

//     console.log("45: isRequestSubmitted: ", isRequestSubmitted.value);
//     // Listen for WebSocket messages and update progress
//     useEffect(() => {
//         if (!socketioInstance.connected) return;
//         console.log("socketioInstance: ", socketioInstance);
//         console.log("IN USEFFECT OF PROGRESS BAR");
//         console.log("socketioInstance.connected: ", socketioInstance.connected);
...
//                 // START TOAST
//                 socketioInstance.on("START_TOAST", (event: MessageEvent) => {
//                     const data = JSON.parse(event.data);
//                     console.log("DATA: ", data);
//                     toastIdRef.current = toast.loading(
//                         <ProgressToast percent={data.percent_complete} message={messageSig.value} />,
...
//             }
//         };
//         socketioInstance.on('message', handleMessage);

//         return () => {
//             socketioInstance.off('message', handleMessage);
//         }
//     }, [socketioInstance, dispatch]);
